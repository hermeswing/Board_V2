...
<form id="form" action="proc.do" method="post">
...
<div id="wrap">
	<div class="line">
		...
		<input type="text" id="author" name="author" title="작성자" maxlength="15" value="${board.author}" <c:if test="${query == 'modify'}">readonly="readonly"</c:if> />
	</div>
	<div class="line">
		<label class="label" for="pwd"><c:if test="${query == 'modify'}">현재 </c:if>비밀번호</label>
		<input type="password" id="pwd" name="pwd"  title="비밀번호" maxlength="15" />
